    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Crea un nuevo evento para tu tienda</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-w-2xl">
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="title" {...register("title")} placeholder="Ej: Día del regalo" />
              {errors.title && (
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Publicar el evento inmediatamente
                </p>
              </div>
              <Switch
                checked={isActive}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Imagen representativa del evento (JPG, PNG o WebP, máx. 5 MB)
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {imageUrl ? (
